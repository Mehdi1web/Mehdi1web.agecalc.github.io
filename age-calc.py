...
monthchoosen = ttk.Combobox(frame, font=(
    "Times", "17"), width=5, textvariable=month)
monthchoosen.pack(side=LEFT, padx=5)
monthchoosen['values'] = months
monthchoosen.current(0)

date_stringvar = StringVar()
datechoosen = ttk.Combobox(frame, font=(
    "Times", "17"), width=5, textvariable=date_stringvar)
...
year = StringVar()
year.set("2023")
yearchoosen = Entry(frame, width=7, font=("Times", "17"),
                    relief='groove', border=2, textvariable=year)
